...
enum class MonsterType {
    BULBASAUR, LVYSAUR, VENUSAUR,
    CATERPIE, METAPOD, ODDISH, VILEPLUME, SCYTHER, BUTTERFREE,
    PSYDUCK, GOLDUCK, POLIWAG, POLIWRATH, JYNX, SUICUNE,
    GROWLITHE, ARCANINE, PONYTA, RAPIDISH, SLUGMA, MAGCARGO, GROUDON,
    END
};
