...
void PKH::D2DRenderManager::DrawUI(TextureKey spriteKey, Vector3 pos, Vector3 scale, int index)
{
	auto find = pD2DRenderManager->textureMap.find(spriteKey);
	if (find == pD2DRenderManager->textureMap.end())
	{
...
void PKH::D2DRenderManager::DrawUIHorizontal(TextureKey spriteKey, Vector3 pos, Vector3 scale, int index, float horizontalPer)
{
	auto find = pD2DRenderManager->textureMap.find(spriteKey);
	if (find == pD2DRenderManager->textureMap.end())
	{
