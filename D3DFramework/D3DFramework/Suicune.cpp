...
Suicune::Suicune()
{
	...
	SetTexture(State::IDLE, TextureKey::SUI_WALK_D_01, 3);
...
void Suicune::RandomMovePattern()
{
	Time[0] += TimeManager::DeltaTime();
...
void Suicune::Attack(Transform* PlayerT)
{
	Time[0] += TimeManager::DeltaTime();
...
void Suicune::CreateBullet(Transform* PlayerT)
{
